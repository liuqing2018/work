...
let colorData = ['#0094da', '#5bc0de', '#e79d47', '#f00', '#5cb85c', '#f4a79d'];
// let colorData = ['#4fc3ba', '#5bb5d8', '#f47564', '#f39c11', '#c1e5e1', '#c5e0eb', '#f4cdc8', '#f2dbaf', '#91d6d1', '#99cde3', '#f4a79d', '#f3bf6c'];
                ...
                itemStyle: {
                    normal: {
                        color: function (params) {
                            ...
                            return colorData[params.dataIndex % colorData.length];
                        },
...
export const barHorizontalCharts = function (params) {
    ...
    let colors = params.colorData || colorData;
...
export const line = function (id, params) {
    // 初始化配置
    if (!params.legend) {
        params.legend = {};
    }
...
export const lineChart = function (id, params) {
    let option = {
        tooltip: {
            trigger: 'axis'
        },
        ...
        color: params.colorData || colorData,
        xAxis: {
            type: 'category',
            boundaryGap: false,
            data: params.xAxis,
    ...
    let checkPersonNumChart = echarts.init(document.getElementById(id));
